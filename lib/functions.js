//--- Name: Functions/Vesion: 0.1.6a/Authors: AlexanderDV/Description: Functions .js. ---
//Element hiding
...
function addMovingElement(moving, mover, onmousedownRealisation, ondragstartRealisation, getCoordsRealisation, moveAtRealisation, onmousemoveRealisation, onmouseupRealisation){
	...
	mover.ondblclick=()=>{
		for(let el of mover.parentNode.children)
			el.classList.toggle("movemin")
		mover.classList.remove("movemin")
	}
}
// Console element
